...
class CalculatorChallengePage extends StatefulWidget {
  ...
  @override
  State<CalculatorChallengePage> createState() => _CalculatorChallengePageState();
}

class _CalculatorChallengePageState extends State<CalculatorChallengePage> {
  static const String _introText =
  "Welcome! In this challenge, you will be given equations to solve. Select the correct answer three times to pass the challenge. Three incorrect answers will result in failure.";
